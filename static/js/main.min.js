...
(function() {
  ...
  (function($) {
    var component_stash, createTask, modal, task_list_changed, task_open;
    component_stash = {};
    modal = "";
    task_list_changed = [];
    task_open = "";
    ...
    $("#new-category-popover-add").on("click", function() {
      return console.log($("#new-category-popover-title-in").val());
    });
