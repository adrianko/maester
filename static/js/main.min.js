...
(function() {
  ...
  (function($) {
    var board_id, component_stash, del_category, edit_category, edit_item, home_board, new_task_category, taskSortable, task_list_changed, task_open;
    component_stash = {};
    new_task_category = "";
    task_list_changed = [];
    task_open = "";
    ...
    $(document.body).on("click", "a.new-task", function() {
      ...
      new_task_category = $(this).attr("data-category");
      return void 0;
    });
    ...
    $(document.body).on("click", ".edit-item", function(e) {
      e.preventDefault();
      e.stopPropagation();
      $(this).parent().find(".editable").editable("toggle");
      edit_item = $(this).attr("data-item");
      return void 0;
    });
    $(document.body).on("click", ".editable-submit", function(e) {
      ...
      $.ajax({
        ...
        success: function(data) {
          console.log(data);
          if (edit_item = "title") {
            return $(".task[data-task='" + task_open + "']").text(value);
          }
        },
        error: function(jqXHR, textStatus, err) {
          return console.log(err);
