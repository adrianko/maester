...
(function() {
  (function($) {
    var board_delete, board_edit, component_stash;
    component_stash = {};
    board_delete = "";
    board_edit = "";
    ...
    $(document.body).on("click", ".board-edit", function(e) {
      ...
      $("#edit-board-modal-title").val($(this).closest(".board-item").find(".board-title").text());
      $("#edit-board-modal-desc").val($(this).closest(".board-item").find(".board-description").text());
    ...
    $(document.body).on("click", "#edit-board-modal-submit", function() {
      var background, description, title;
