...
(function() {
  ...
  (function($) {
    var component_stash, saveTaskDetails, task_category, task_open, task_order;
    component_stash = {};
    task_category = "";
    task_order = [];
    task_open = "";
    ...
    window.convertDuration = function(d) {
      var duration, duration_unit;
      duration = d;
      duration_unit = "";
      if (duration < 1800) {
        duration = "";
        ...
        duration_unit = "hr";
      } else if (duration >= 43200 && duration < 604800) {
    ...
    saveTaskDetails = function() {
      var description, duration, duration_unit, s, title, users, _i, _len, _ref;
      ...
      users = JSON.stringify((function() {
        ...
        _ref = $("#edit-task-modal-users .selected");
        _results = [];
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          return $("#task-duration [data-subitem='duration-unit']").text(d.duration_unit);
        },
        error: function(jqXHR, textStatus, err) {
          return console.log(err);
        }
    ...
    $(document.body).on("click", ".task", function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          var d, duration, duration_unit, u, _i, _len, _ref;
          if (data.code !== 200) {
            return console.log("ERROR: " + data.code);
          } else {
            data = data.data[0];
    ...
    $(".task-detail-container").hover(function() {
      return $(this).find(".edit-item").css("display", "inline-block");
    }, function() {
      return $(this).find(".edit-item").css("display", "none");
    });
    $(document.body).on("click", ".edit-item", function(e) {
      ...
      $(this).closest(".task-detail-container").find(".task-item-detail-view[data-item='" + item + "']").hide();
      $(this).closest(".task-detail-container").find(".task-item-detail-edit[data-item='" + item + "']").show();
      return void 0;
    });
    $(document.body).on("click", ".task-item-detail-edit", function(e) {
      e.preventDefault();
      e.stopPropagation();
      return void 0;
    });
    $(document.body).on("click", "#task-details-modal", function(e) {
      e.preventDefault();
      e.stopPropagation();
      if ($(".task-item-detail-edit:visible").length > 0) {
        saveTaskDetails();
